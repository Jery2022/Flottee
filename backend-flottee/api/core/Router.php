<?php
// backend-flottee/api/core/Router.php

namespace Core;

use Core\Response;

class Router { private array $routes = []; private string $groupPrefix = '';
...
public function resource(string $basePath, string $controller): void
{
    ...
    $this->add('GET', "$basePath/email/{email}", "$controller@findByEmail");
}
